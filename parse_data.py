...
Eu = ['Austria','Belgium','Bulgaria','Croatia','Cyprus','Czech Republic','Denmark','Estonia','Finland','France','Germany','Greece','Hungary','Ireland','Italy','Latvia','Lithuania','Malta','Luxembourg','Netherlands','Poland','Portugal','Romania','Slovak Republic','Slovenia','Spain','Sweden','United Kingdom']
...
all_countries = ['East Asia'] + EastAsia + ['South Asia'] + SouthAsia + ['West Asia'] + WestAsia + ['North Asia'] + NorthAsia + ['Southeast Asia'] + SoutheastAsia +['Non EU'] + NonEu +['EU'] + Eu + ['Africa'] + Africa + ['North America'] + NorthAmerica + ['South America'] + SouthAmerica + ['Oceania'] + Oceania
...
indices = [index_dict['East Asia'], index_dict['South Asia'],index_dict['West Asia'],index_dict['North Asia'],index_dict['Southeast Asia'],index_dict['Non EU'],index_dict['EU'],index_dict['Africa'],index_dict['North America'],index_dict['South America'],index_dict['Oceania']]
...
for d in all_countries:
    ...
    for c in country_list:
        ...
        if c in SoutheastAsia:
            ...
            continue
        if c in NonEu:
            small_dict['Non EU'] += small_dict[c]
            continue
        if c in Eu:
            small_dict['EU'] += small_dict[c]
            continue
        if c in Africa:
